    ...
    <Wrapper>
      <div className={`modal ${modalIsOpen}`}>
        <div
          ...
          onClick={() => setModalIsOpen("open-modal")}
        >
          ...
          <div className="position">{item?.dev_type}</div>
          ...
          <div className="social_media">
                  ...
                  <defs>
                    <clipPath id="clip0_352_8">
                      <rect
                        ...
                        height="15.6461"
                        fill="white"
                        transform="translate(0.0268555 0.0267334)"
                      />
                    </clipPath>
                  </defs>
                </svg>
                  ...
                  <defs>
                    <clipPath id="clip0_352_10">
                      <rect
                        ...
                        height="16.8496"
                        fill="white"
                        transform="translate(0.76123 0.424805)"
                      />
                    </clipPath>
                  </defs>
                </svg>
            ...
            <div className="social_icon">
              <a href={item?.social_media?.email} rel="noopener noreferrer">
                ...
                >
                  <path
                    d="M15.46 3.93237H4.57796C3.95951 3.93237 3.36639 4.17805 2.92908 4.61536C2.49177 5.05267 2.24609 5.64579 2.24609 6.26424V14.0371C2.24609 14.6556 2.49177 15.2487 2.92908 15.686C3.36639 16.1233 3.95951 16.369 4.57796 16.369H15.46C16.0785 16.369 16.6716 16.1233 17.1089 15.686C17.5462 15.2487 17.7919 14.6556 17.7919 14.0371V6.26424C17.7919 5.64579 17.5462 5.05267 17.1089 4.61536C16.6716 4.17805 16.0785 3.93237 15.46 3.93237ZM15.46 5.48695L10.4076 8.96144C10.2895 9.02966 10.1554 9.06558 10.019 9.06558C9.88255 9.06558 9.74851 9.02966 9.63035 8.96144L4.57796 5.48695H15.46Z"
                    fill="#DF0606"
                  />
                </svg>
              </a>
